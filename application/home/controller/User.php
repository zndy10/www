...
//            $this->verifyHandle('user_reg');
    ...
    public function info(){
        ...
        // 获取用户vip等级
        $user_info['vip_level'] = $this->getUserVipLevel($user_info['total_amount']);
   ...
   public  function recharge(){
    ...
    public function getUserVipLevel($total_amount) {
        if ($total_amount<VIP::REG) {
            exit;
        }
        if ($total_amount < (VIP::VIP1) && $total_amount> VIP::REG ) {
            $vip_level = '注册会员';
        } elseif ($total_amount< (VIP::VIP2) && $total_amount> VIP::VIP1) {
            $vip_level = '铜牌会员';
        } elseif ($total_amount< (VIP::VIP3) && $total_amount> VIP::VIP2) {
            $vip_level = '白银会员';
        } elseif ($total_amount< (VIP::VIP4) && $total_amount> VIP::VIP3) {
            $vip_level = '黄金会员';
        } elseif ($total_amount< (VIP::VIP5) && $total_amount> VIP::VIP4) {
            $vip_level = '钻石会员';
        } else {
            $vip_level = '超级VIP';
        }
