...
<div class="slidebar-right">
	...
	<a class="slidebar-item ico-slidebar3" target="_blank" href="javascript:;" >
		...
		<div class="sbar-hover-pic">
			<div class="qrcode-wrap"><img class="w-100" src="/index.php?m=Home&c=Index&a=qr_code&data=<?php echo $mobile_url; ?>&head_pic=<?php echo $head_pic; ?>&back_img=<?php echo $back_img; ?>" alt="" /></div>
