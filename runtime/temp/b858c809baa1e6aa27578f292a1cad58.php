<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/system\shop_info.html";i:1522317281;s:61:"D:\phpStudy\WWW\www\application\admin\view\public\layout.html";i:1522317281;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <div class="system_img_location">
                        <a title="图片所在位置" href="/public/static/images/logo/pc_home_logo_pos.png" class="pic-thumb-tip" onmouseover="layer.tips('<img src=/public/static/images/logo/pc_home_logo_pos.png>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"><i class="fa fa-picture-o"></i></a>
                    </div>
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <div class="system_img_location">
                        <a title="图片所在位置" href="/public/static/images/logo/pc_home_user_logo_pos.png" class="pic-thumb-tip" onmouseover="layer.tips('<img src=/public/static/images/logo/pc_home_user_logo_pos.png>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <div class="system_img_location"><a title="图片所在位置" href="/public/static/images/logo/storeico_pos.png" class="pic-thumb-tip" onmouseover="layer.tips('<img src=/public/static/images/logo/storeico_pos.png>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"><i class="fa fa-picture-o"></i></a>
                    </div>
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <div class="system_img_location">
                        <a title="图片所在位置" href="/public/static/images/logo/admin_login_logo_pos.png" class="pic-thumb-tip" onmouseover="layer.tips('<img src=/public/static/images/logo/admin_login_logo_pos.png>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"><i class="fa fa-picture-o"></i></a>
                    </div>
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show">
                        <span class="show">
                            <a id="admin_home_logo_a" class="nyroModal" rel="gal" href="<?php echo (isset($config['admin_home_logo']) && ($config['admin_home_logo'] !== '')?$config['admin_home_logo']:'/public/static/images/logo/admin_home_logo_default.png'); ?>">
                                <i id="admin_home_logo_i" class="fa fa-picture-o" onmouseover="layer.tips('<img src=<?php echo (isset($config['admin_login_logo']) && ($config['admin_login_logo'] !== '')?$config['admin_login_logo']:'/public/static/images/logo/admin_home_logo_default.png'); ?>>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"></i>
                            </a>
                        </span>
           	            <span class="type-file-box">
                    ...
                    <div class="system_img_location">
                        <a title="图片所在位置" href="/public/static/images/logo/admin_home_logo_pos.png" class="pic-thumb-tip" onmouseover="layer.tips('<img src=/public/static/images/logo/admin_home_logo_pos.png>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"><i class="fa fa-picture-o"></i></a>
                    </div>
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <div class="system_img_location">
                        <a title="图片所在位置" href="/public/static/images/logo/wap_home_logo_pos.png" class="pic-thumb-tip" onmouseover="layer.tips('<img src=/public/static/images/logo/wap_home_logo_pos.png>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"><i class="fa fa-picture-o"></i></a>
                    </div>
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <div class="system_img_location">
                        <a title="图片所在位置" href="/public/static/images/logo/wap_login_logo_pos.png" class="pic-thumb-tip" onmouseover="layer.tips('<img src=/public/static/images/logo/wap_login_logo_pos.png>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"><i class="fa fa-picture-o"></i></a>
                    </div>
                    <span class="err"></span>
