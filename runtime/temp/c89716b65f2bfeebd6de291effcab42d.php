<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view/promotion\flash_sale.html";i:1522317281;s:61:"D:\phpStudy\WWW\www\application\admin\view\public\layout.html";i:1522317281;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table>
					...
					<?php if(is_array($prom_list) || $prom_list instanceof \think\Collection || $prom_list instanceof \think\Paginator): if( count($prom_list)==0 ) : echo "" ;else: foreach($prom_list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 240px;"><a href="<?php echo U('Home/Goods/goodsInfo',['id'=>$vo[goods_id],'item_id'=>$vo[item_id]]); ?>"><?php echo $vo['title']; ?></a></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="">
								<div style="text-align: center; width: 50px;"><?php echo $vo['status_desc']; ?></div>
							</td>
