<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"./application/admin/view/order\refund_order_list.html";i:1522317281;s:61:"D:\phpStudy\WWW\www\application\admin\view\public\layout.html";i:1522317281;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="item-title">
      <div class="subject">
		...
		<ul class="tab-base nc-row">
			<li><a <?php if(\think\Request::instance()->param('prom_type') != 6): ?>class="current"<?php endif; ?> href="<?php echo U('Order/refund_order_list'); ?>"><span>全部</span></a></li>
			<li><a <?php if(\think\Request::instance()->param('prom_type') == 6): ?>class="current"<?php endif; ?> href="<?php echo U('Order/refund_order_list',['prom_type'=>6]); ?>"><span>拼团退款单</span></a></li>
		</ul>
    </div>
  </div>
  <!-- 操作说明 -->
  ...
  <div class="flexigrid">
    <div class="mDiv">
      ...
      <div class="sDiv">
        <div class="sDiv2">
        	<input type="text" size="30" id="consignee"  name="consignee"  value="<?php echo \think\Request::instance()->param('consignee'); ?>" class="qsbox"  placeholder="收货人">
        </div>
        <div class="sDiv2">
        	<input type="text" size="30" id="order_sn" name="order_sn" value="<?php echo \think\Request::instance()->param('order_sn'); ?>" class="qsbox"  placeholder="订单编号">
        </div>
        <div class="sDiv2">	 
			<input type="text" size="30" id="mobile" name="mobile" value="<?php echo \think\Request::instance()->param('mobile'); ?>" class="qsbox"  placeholder="联系电话">
        </div>
        <div class="sDiv2">	 
