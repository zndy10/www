<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view/system\express.html";i:1522317281;s:61:"D:\phpStudy\WWW\www\application\admin\view\public\layout.html";i:1522317281;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" id="handlepost" action="<?php echo U('System/handle'); ?>" enctype="multipart/form-data" name="form1">
        ...
        <div class="ncap-form-default">
            <dl class="row">
				...
				<dd class="opt">
                    <input type="radio" name="express_switch" value="0" <?php if($config[express_switch] == 0): ?> checked <?php endif; ?>>快递100&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="express_switch" value="1" <?php if($config[express_switch] == 1): ?> checked <?php endif; ?>>快递鸟 &nbsp;&nbsp;&nbsp;&nbsp;
                </dd>
            </dl>
            <dl class="row kd100">
                <dt class="tit">
