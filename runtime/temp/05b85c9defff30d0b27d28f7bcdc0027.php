<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/mobile_app\index.html";i:1522317281;s:61:"D:\phpStudy\WWW\www\application\admin\view\public\layout.html";i:1522317281;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <!--<div class="input-file-show">
                    ...
                    <input id="app_version"  value="<?php echo $config['app_path']; ?>" class="input-txt" type="text" disabled/>
